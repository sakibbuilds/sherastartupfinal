  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        ghost: "bg-transparent hover:bg-secondary hover:text-secondary-foreground rounded-xl",
        link: "text-primary underline-offset-4 hover:underline",
        navy: "bg-primary text-primary-foreground shadow-navy hover:shadow-navy-lg hover:-translate-y-0.5",
        soft: "bg-transparent text-foreground border border-border/50 shadow-soft hover:shadow-soft-md hover:-translate-y-0.5 hover:bg-secondary/50",
        ...
        "hero-outline": "border-2 border-primary/30 bg-transparent backdrop-blur-sm text-primary px-8 py-6 text-base font-semibold hover:bg-primary hover:text-primary-foreground hover:border-primary",
        glass: "bg-transparent backdrop-blur-xl border border-border/50 text-foreground hover:bg-secondary/50 hover:shadow-soft-md",
        icon: "bg-transparent border border-border/30 text-foreground shadow-soft hover:shadow-soft-md hover:bg-secondary",
      },
      size: {
